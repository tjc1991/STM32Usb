...
public class UsbDriver{
	...
	private UsbEndpoint[] BulkInEndpoint = new UsbEndpoint[7];
	private UsbEndpoint[] BulkOutEndpoint = new UsbEndpoint[7];
	private UsbDeviceConnection connection;
	private PendingIntent pendingIntent;
	
	public UsbFace usbface=null;
	...
	public UsbDriver(UsbManager usbManager,PendingIntent pendingIntent,UsbFace usbFace) {
		super();
		this.usbManager = usbManager;
		this.pendingIntent = pendingIntent;
		this.usbface = usbFace;
	}
	...
	public UsbDevice ScanDevices() {
		...
		for(UsbDevice device : map.values()){
			...
			//usbface.ReceiveMsg("vid:"+device.getVendorId()+"\n"+"   pid:"+device.getProductId()+"\n"+"   "+"device="+device.getDeviceName()+"\n");
	...
	public int OpenDevice(){
		...
		//usbface.ReceiveMsg(usbDevice.getInterfaceCount()+"");
		int i=0;
		int j=0;
		int k=0;
